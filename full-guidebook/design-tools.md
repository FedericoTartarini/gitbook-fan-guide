...
![Figure 57. Example of the CBE Thermal Comfort Tool, showing user inputs, psychometric chart, and results.](<../.gitbook/assets/0 (3).png>)
...
![Figure 58. Example of the CBE Thermal Comfort Tool showing air speed vs. operative air temperature mode.](<../.gitbook/assets/1 (19).png>)
...
![Figure 59. Example CBE Ceiling Fan Design Tool outputs.](<../.gitbook/assets/2 (1).png>)



![Figure 60. Example cell plan from CBE Ceiling Fan Design Tool.](../.gitbook/assets/3.png)

![Figure 61. Example cell section from CBE Ceiling Fan Design Tool.](<../.gitbook/assets/4 (3).png>)
...
![Figure 62. Example of the Setpoint Energy Saving Calculator](<../.gitbook/assets/5 (3).png>)
