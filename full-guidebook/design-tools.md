...
![Figure 57. Example of the CBE Thermal Comfort Tool, showing user inputs, psychometric chart, and results.](<../.gitbook/assets/0 (16).png>)
...
![Figure 58. Example of the CBE Thermal Comfort Tool showing air speed vs. operative air temperature mode.](<../.gitbook/assets/1 (3).png>)
...
![Figure 59. Example CBE Ceiling Fan Design Tool outputs.](<../.gitbook/assets/2 (13).png>)



![Figure 60. Example cell plan from CBE Ceiling Fan Design Tool.](<../.gitbook/assets/3 (8) (1).png>)
...
![Figure 62. Example of the Setpoint Energy Saving Calculator](<../.gitbook/assets/5 (9).png>)
