...
![Figure S1. Floor plan and air speed distribution in the 4 tested buildings. The magnitude of air speed at each site is averaged by heights.](<../.gitbook/assets/1 (16).png>)
...
![Figure S2. Air speed distribution at 4 sites for different (i) operating directions (downward – purple; upward – green); (ii) fan rotational speed; (iii) operating fan number (if available); and (iv) before and after averaging by heights.](<../.gitbook/assets/2 (19).png>)
...
![Figure S3 Cooling effects in different test conditions and buildings. Characteristics of the plot are the same as describing in Figure FS9](<../.gitbook/assets/3 (18).png>)
...
Description automatically generated with medium confidence](<../.gitbook/assets/6 (6).png>)
...
Description automatically generated with medium confidence](<../.gitbook/assets/10 (3).png>)
...
<figure><img src="../.gitbook/assets/mean hourly power consumpsion _anb horizotal (1).png" alt=""><figcaption><p>Figure S12. Mean hourly power consumption for (a) air conditioning compressor and (b) ceiling fan. Dashed lines on x-axes and y-axes indicates median, solid line indicates mean.</p></figcaption></figure>
