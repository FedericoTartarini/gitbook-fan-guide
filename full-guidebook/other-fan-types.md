...
![Figure 25. CFE index versus fan power for the ceiling fan (CF), desk fan (DF) standing fan (SF) and tower fan (TF). Lines with constant whole-body cooling effect (∆teq) are plotted.](<../.gitbook/assets/5 (6).png>)
...
![Figure 29. Schematic of airflow pattern driven by air circulator.](<../.gitbook/assets/9 (7).png>)
